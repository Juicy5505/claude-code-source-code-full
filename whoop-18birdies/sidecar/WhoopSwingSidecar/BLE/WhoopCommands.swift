...
enum WhoopCommands {
    ...
    static func enableIMUStream(generation: WhoopGeneration) -> [Data] {
        ...
        case .whoop5:
            // Maverick toggleImuMode expects [revision, on/off] per OpenStrap edge.
            return [
                frame(generation: .whoop5, cmd: .toggleIMU, payload: [0x01, 0x01]),
                frame(generation: .whoop5, cmd: .sendR10R11Realtime, payload: [0x01]),
            ]
        }
    }
    ...
    static func disableIMUStream(generation: WhoopGeneration) -> [Data] {
        ...
        case .whoop5:
            return [
                frame(generation: .whoop5, cmd: .sendR10R11Realtime, payload: [0x00]),
                frame(generation: .whoop5, cmd: .toggleIMU, payload: [0x01, 0x00]),
            ]
        }
    }
    ...
    static func connectHandshake(generation: WhoopGeneration) -> [Data] {
        ...
        case .whoop5:
            return [WhoopFraming.gen5ClientHello, setClock(generation: .whoop5)]
        }
    }
